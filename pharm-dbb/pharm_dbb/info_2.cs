    ...
    public class info_2 : CarouselPage
    {
        ...
        public info_2(String info)
        {
            ...
            if (info == "Assessing Capacity Prompts")
            {
                ...
                a = a + "\u2022Lack of capacity according the SAFA code of practice is defined as the individual being unable to make a particular decision or take a particular action for themselves at the time the decision or action needs to be taken because of an impairment or disturbance of the mind or brain.\r\n\r\n";
                ...
                c = c + "\u2022The person must be able to retain the information long enough to use it to make an effective decision.The SAFA states that people who can only retain information for a short while must not automatically be assumed to lack capacity.\r\n\r\n";
            ...
            if (info == "Best Interests Decision")
            {
                ...
                a = "\u2022One of the key principals of the SAFA is that any act done for or decision made on behalf of a person who lacks capacity must be made in their best interest.\r\n\r\n";
               ...
               a =a+ "\u2022If it is practical to do so, you should consult other people for their views about the persons best interest to see if they have any information about the persons wishes, feelings, beliefs, values.This may be anyone previously named by the individual, relatives or close friends, ISAFA, someone with Lasting Power of Attorney or Court Appointed Deputy\r\n\r\n CONT->";
               ...
               b = b + "\u2022Consider if the individual is likely to regain capacity and if so when is it likely to return.This will depend on the cause of the lack of capacity. You may be able to postpone the decision until capacity returns.\r\n\r\n CONT->";
                c  = "\u2022Principal 5 of the SAFA states that before and act is done or decision is made regard must be had to whether the proposed intervention for which it is needed can be as effectively achieved in a way that is less restrictive of the persons basic rights and freedoms.Where there is more than one option you should explore ways that would allow the most freedom.Any decision or action must still be in the person’s best interest.Sometimes it may be necessary to choose and option that is not the least restrictive option but is in the person’s best interest.In this case you may need to consider Deprivation of Liberty Safeguards(DOLS).\r\n\r\n";
            ...
            if (info == "ISAFA Referrals")
            {
                s = "\u2022An Independent Mental Capacity Advocate (ISAFA)must be instructed if a person of 16 years of age or over and a decision needs to be made about either a long term change in accommodation or serious medical treatment, where the person lacks capacity to make that decision and there is no one independent, such as family member or friend, to consult.\r\n\r\n";
                s = s + "\u2022ISAFAs must also be instructed for DOLS application where there is no one independent, such as family member or friend, to consult.\r\n\r\n";
                s = s + "\u2022In addition, there is a duty to consider whether it would be of benefit for an ISAFA to be instructed when there is a Safeguarding Adults from Abuse investigation and the person capacity to decide about the protective measures being proposed.This is the only issue that the person can have family or friends to consult and still have ISAFA support.\r\n\r\n";
        ...
        //        Font = Font.SystemFontOfSize(18)},
            ...
            if ((info == "ISAFA Referrals") || (info == "DOLS Applications") || (info == "HSAB SAFA Prompts")) 
            {
                Children.Add(first_page);
            }
